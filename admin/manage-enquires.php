...
$msg="feedback successfully readed";
}
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Feedbacks</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td width="300"><?php echo htmlentities($result->Description);?></td>
								...
								<td width="170"><?php echo htmlentities($result->PostingDate);?></td>
